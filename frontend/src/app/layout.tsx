...
export const metadata: Metadata = {
  ...
  title: { default: "DataBridge — API integration & data sync", template: "%s · DataBridge" },
  description: "Connect REST APIs and webhooks: fetch records, map and transform fields, deliver with retries, and inspect every run.",
};
